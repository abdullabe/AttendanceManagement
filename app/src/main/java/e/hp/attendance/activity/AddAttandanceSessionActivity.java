package e.hp.attendance.activity;
...
import e.hp.attendance.context.Sessiondata;
import e.hp.attendance.db.DBAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				FacultyBean bean=((Sessiondata)AddAttandanceSessionActivity.this.getApplicationContext()).getFacultyBean();
				...
				((Sessiondata)AddAttandanceSessionActivity.this.getApplicationContext()).setStudentBeanList(studentBeanList);
		...
		viewAttendance.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				((Sessiondata)AddAttandanceSessionActivity.this.getApplicationContext()).setAttendanceBeanList(attendanceBeanList);
